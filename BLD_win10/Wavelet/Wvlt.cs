...
namespace BLD_win10.Wavelet
{
    public class Wvlt
    {
        ...
        db5 = { 0.11321f, 0.42697f, 0.51216f, 0.097883f, -0.17133f, -0.022801f, 0.054851f, -0.0044134f, -0.0088959f, -0.019788f, -0.13225f, 0.0023587f },
        /*
        0.021808f, 
        0.023252f, 
        */
        ...
        db9 = {0.026925f,0.17242f,0.42767f,
        0.46477f, 0.094185f,-0.20738f, -0.068477f, 0.10503f, 0.021726f, -0.047824f,
        0.00017745f, 0.015812f, -0.0033398f, -0.0030275f, 0.0013065f, 0.00016271f,
        -0.00017816f, 2.7823e+005f },

        dbl0 ={0.018859f,0.13306f,0.37279f,
        0.48681f, 0.19882f, -0.17667f, -0.13855f, 0.090064f, 0.065801f,-0.050483f,
        ...
        */
        ...
        coif2 =
        {0.011588f, -0.02932f, -0.04764f, 0.27302f, 0.57468f,0.29487f,-0.054086f,-0.042026f,
        0.016744f,0.0039679f,-0.0012892f,-0.00050951f },

        coif3 =
        {-0.0026824f,0.0055031f,0.016584f,-0.046508f,-0.043221f,0.2865f,0.56129f,0.30298f,
        -0.05077f,-0.058196f,0.024434f,0.011229f,-0.0063696f,-0.0018205f,0.00079021f,
        0.00032967f,-5.0193e-005f,-2.4466e-005f },


        coif4 =
        {0.00063096f,-0.0011522f,-0.0051945f,0.011362f,0.018867f,-0.057464f,-0.039653f,
        ...
        dmey =
        {-7.1418e-013f,6.0242e-009f,-7.8626e-009f,-7.6359e-009f,4.29e-008f,-7.6838e-008f,
        ...
        df1_5 = {0.0117f,-0.0117f,-0.0859f,0.0859f, 0.5000f, 0.5000f, 0.0859f,
        -0.0859f },
        ...
        rf4_4 =
        {-0.0456f,-0.0288f,0.2956f,0.5575f,0.2956f,-0.0288f,-0.0456f },

        df5_5 = {0.0281f,0.0056f,-0.0385f, 0.2444f, 0.5209f, 0.2444f, -0.0385f,
        0.0056f,0.0281f },

        rf5_5 = {0.0095f,-0.0019f,-0.0967f, -0.0661f,0.3372f, 0.6360f, 0.3372f,
        -0.0661f,-0.0967f, -0.0019f, 0.0095f },

        df6_8 = {0.0013f,-0.0014f,-0.0120f, 0.0084f, 0.0352f ,-0.0546f, -0.0665f,
        0.2975f,0.5840f,0.2975f,-0.0665f, -0.0546f, 0.0352f, 0.0084f, -0.0120f,
        -0.0014f,0.0013f },
...
switch (fltnm) 
            {
case "haar": 
case "dbl ": LPrime = new Seq(dbl); GetFilters(LPrime);break; 
...
case "dbl 0": LPrime = new Seq(dbl 0); GetFilters(LPrime);break; 
...
case "biorl .5" : 
Seq(df1_5); CalcuBior();break; 
case "bior2.2" • 
Seq(df2_2); CalcuBior();break; 
case "bior3.1" : 
Seq(df3_1); CalcuBior();break; 
case "bior4.4" • 
Seq(df4_4); CalcuBior();break; 
case "bior5.5" • 
Seq(df5_5); CalcuBior();break; 
case "bior6.8" 
Seq(df6_8); CalcuBior();break; 
_ new Seq(rf1_3); Lo_D = new
_ new Seq(rf1_5); Lo_D = new
_ new Seq(rf2_2); Lo_D = new
_ new Seq(rf3_1); Lo_D = new
_ new Seq(rf4_4); Lo_D = new
_ new Seq(rf5_5); Lo_D = new
_ new Seq(rf6_8); Lo_D = new 
